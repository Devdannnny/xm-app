...
<body class="antialiased">
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-black selection:bg-red-500 selection:text-white">
        @if (Route::has('login'))
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class=" w-[400px]">
                    <div class="scale-100 w-full p-6 bg-white via-transparent  dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none motion-safe:hover:scale-[1.01] transition-all duration-[.3s] focus:outline focus:outline-2 focus:outline-red-500" style="background: #121319 !important;">
                        <form id="my-form" action="javascript:void(0)" class="p-6 rounded shadow-md">
                            <div class="mb-4">
                              <label class="block text-gray-400 font-bold mb-2" for="symbol">
                                Company Symbol:
                              </label>
                              <div class="relative">
                                <select class="w-full symbolDet appearance-none px-3 py-2 border border-gray-500  focus:border-gray-300 hover:border-gray-300 outline-none rounded dark:bg-gray-800/50 text-white" id="symbol" name="symbol" required>
                            ...
                            <div class="mb-4">
                              ...
                              <input class="w-full px-3 py-2 border border-gray-500 focus:border-gray-300 hover:border-gray-300 outline-none rounded dark:bg-gray-800/50 text-white datepicker" type="text" id="start-date" name="start-date" required>
                            ...
                            <div class="mb-4">
                              ...
                              <input class="w-full px-3 py-2 border border-gray-500 focus:border-gray-300 hover:border-gray-300 outline-none rounded dark:bg-gray-800/50 datepicker text-white" type="text" id="end-date" name="end-date" required>
                            ...
                            <div class="mb-4">
                              ...
                              <input class="w-full px-3 py-2 border border-gray-500 focus:border-gray-300 hover:border-gray-300 outline-none rounded dark:bg-gray-800/50 text-white" type="email" id="email" name="email" required>
            ...
            <div class="flex justify-center mt-16 px-8 sm:items-center sm:justify-between fixed bottom-0 py-6 w-full left-0">
                ...
                <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    Developed with Laravel v{{ Illuminate\Foundation\Application::VERSION }}, Tailwind css & (PHP v{{ PHP_VERSION }})
                </div>
            </div>
        </div>
    </div>
